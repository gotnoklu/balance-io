...
import { getCurrentBoardId, getPanelsByBoardId } from '../../storage/redux/selectors'
...
const TaskCard = ( {
	...
	const classes = useStyles( { expanded, themeType: theme.type } )

	const currentBoard = useSelector( getCurrentBoardId )
	const panels = useSelector( getPanelsByBoardId( currentBoard ) )
