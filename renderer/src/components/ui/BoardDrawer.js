...
import { drawerWidth, pageRoutes } from '../../constants'
import { useDispatch, useSelector } from 'react-redux'
import { setCurrentBoard } from '../../storage/redux/actions'
...
const BoardDrawer = ( { open } ) => {
	...
	const filteredBoards = boards.filter( board => board.id !== current_board )

	const handleOpenBoardsPage = () => router.push( pageRoutes.BOARDS )

	const handleSelectBoard = boardId => dispatch( setCurrentBoard( boardId ) )
